...
function GreetingCardShell({ guestName }: { guestName: string }) {
  return (
    <div className="relative w-full max-w-[17rem] bg-paper/70 px-7 py-3.5 text-center backdrop-blur-[2px]">
      ...
      {guestName && (
        <>
          <span className="rule-gild mx-auto mt-3 block w-12" />
          <p className="mt-2.5 font-display text-[29px] font-normal leading-tight text-on-maroon">
            {guestName}
          </p>
        </>
      )}
