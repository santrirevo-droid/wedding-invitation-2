    ...
    >
      <defs>
        ...
        <linearGradient id="bride-bg" x1="0" y1="0" x2="0" y2="1">
          ...
          <stop offset="100%" stopColor="#f1d7d6" />
        </linearGradient>
        <linearGradient id="bride-hijab" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#d9a5ac" />
          <stop offset="100%" stopColor="#a2606c" />
        </linearGradient>
        <linearGradient id="bride-hijab-inner" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#e8bcc2" />
          <stop offset="100%" stopColor="#c98a95" />
        </linearGradient>
      </defs>
      ...
      <g clipPath="url(#bride-arch)">
        ...
        <g>
          <circle cx="136" cy="264" r="8" fill="#f0d3c4" />
          <circle cx="150" cy="256" r="9" fill="#e8bcc2" />
          <circle cx="164" cy="264" r="8" fill="#f0d3c4" />
          <circle cx="150" cy="272" r="7" fill="#c98a95" />
          <circle cx="150" cy="264" r="4" fill="#7c4e58" />
        </g>
      </g>
