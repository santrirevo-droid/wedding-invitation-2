    ...
    >
      <defs>
        ...
        <linearGradient id="groom-suit" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#8a5b61" />
          <stop offset="100%" stopColor="#674049" />
        </linearGradient>
      </defs>
      ...
      <g clipPath="url(#groom-arch)">
        ...
        />
        {/* lapels */}
        <path d="M150,224 L118,224 L128,300 L150,270 Z" fill="#573339" />
        <path d="M150,224 L182,224 L172,300 L150,270 Z" fill="#573339" />
        {/* shirt collar */}
        <path d="M150,224 L134,236 L150,258 L166,236 Z" fill="#fdf6f2" />
        {/* tie */}
        <path d="M143,236 L157,236 L152,300 L150,312 L148,300 Z" fill="#6b7d52" />
